...
// void CBoid::FlockIt (int flock_id, CBoid *first_boid, float deltaTime)
// {
...
//    m_pos += m_vel*deltaTime;      // apply velocities.
...
// {
//    ProfileBegin( "Compute Roll Pitch Yaw" );
...
//    ProfileEnd( "Compute Roll Pitch Yaw" );
