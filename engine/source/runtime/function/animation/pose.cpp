    ...
    for (int i = 0; i < m_bone_poses.size(); i++)
    {
        ...
        if (sum_weight != 0)
        {
            ...
            bone_trans_one.m_position =
                bone_trans_one.m_position * cur_weight + bone_trans_two.m_position * (1 - cur_weight);
            bone_trans_one.m_scale = bone_trans_one.m_scale * cur_weight + bone_trans_two.m_scale * (1 - cur_weight);

            bone_trans_one.m_rotation =
                Quaternion::sLerp(1 - cur_weight, bone_trans_one.m_rotation, bone_trans_two.m_rotation, true);
        }
    }
}
