...
namespace Piccolo
{
    const Matrix3x3_ Matrix3x3_::ZERO({0, 0, 0, 0, 0, 0, 0, 0, 0});
    const Matrix3x3_ Matrix3x3_::IDENTITY({1, 0, 0, 0, 1, 0, 0, 0, 1});

    Matrix3x3_::Matrix3x3_(const float (&float_array)[9])
    {
    ...
    FMatrix3 Matrix3x3_::toFMatrix3() const
    {
        FMatrix3 data;
        data << v0, v1, v2, v3, v4, v5, v6, v7, v8;
        return data;
    }

    void Matrix3x3_::fromFMatrix3(const FMatrix3& v)
    {
        v0 = v(0, 0);
        v1 = v(0, 1);
        v2 = v(0, 2);
