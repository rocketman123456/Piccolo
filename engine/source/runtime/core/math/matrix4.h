...
namespace Piccolo
{
    ...
    */
    ...
    public:
        Matrix4x4_() {}
        Matrix4x4_(const float (&float_array)[16]);
        ...
        FMatrix4 toFMatrix4() const;
        void     fromFMatrix4(const FMatrix4& v);

        static const Matrix4x4_ ZERO;
        static const Matrix4x4_ ZEROAFFINE;
        static const Matrix4x4_ IDENTITY;
    };
