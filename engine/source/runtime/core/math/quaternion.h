...
namespace Piccolo
{
    ...
    public:
        ...
        FQuaternion toFQuaternion() const;
        void fromFQuaternion(const FQuaternion& q);

        // void fromRotationMatrix(const Matrix3x3& rotation);
        // void toRotationMatrix(FMatrix3x3 & rotation) const;
        // void toRotationMatrix(FMatrix4x4 & rotation) const;
