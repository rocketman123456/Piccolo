...
namespace Piccolo
{
    REFLECTION_TYPE(Matrix3x3_)
    CLASS(Matrix3x3_, Fields)
    {
        REFLECTION_BODY(Matrix3x3_);

    public:
        Matrix3x3_() {}
        Matrix3x3_(const float (&float_array)[9]);

        FMatrix3 toFMatrix3() const;
        void fromFMatrix3(const FMatrix3& v);
        ...
        static const Matrix3x3_ ZERO;
        static const Matrix3x3_ IDENTITY;
    };
